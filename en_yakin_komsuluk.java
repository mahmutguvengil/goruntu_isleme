...
import vpt.algorithms.io.Load;
	...
	public class en_yakin_komsuluk {
		public static void Atama (Image geciciresim,Image resim,int n) //Fonksiyonda bana verilen resmi yeni olusturucagým resim ve kac katý olmasý ýcýn
		{															   //parametrelerimiz var.Burda sadece eski resmimizin pixellerini aldýk ve yeni resmimize
			for(int x=0; x<geciciresim.getXDim();x++)				   //n oranýnda bosluklarla yerlestirdik.
			{
